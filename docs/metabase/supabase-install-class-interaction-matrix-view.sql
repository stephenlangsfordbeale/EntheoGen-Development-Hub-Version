-- Human-friendly duplicate (paste in dashboard): install class_interaction_matrix.
-- Keep this file aligned with:
--   docs/metabase/class_interaction_matrix.sql
--   supabase/migrations/20260504083000_public_class_interaction_matrix_view.sql
--
-- Requires public.interactions_enriched to exist first.
drop view if exists public.class_interaction_matrix;

create view public.class_interaction_matrix
...
comment on view public.class_interaction_matrix is
  'Class-to-class risk matrix built from public.interactions_enriched with normalized pair-id class joins.';
